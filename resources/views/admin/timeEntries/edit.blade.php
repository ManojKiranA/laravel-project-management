...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.timeEntry.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.time-entries.update", [$timeEntry->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
